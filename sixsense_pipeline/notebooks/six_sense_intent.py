...
schema = [
    'CRM Account ID', 'CRM Account Name', 'CRM Account Country', 'CRM Account Domain',
    'Keyword Researched', 'Keyword Category', 'Total', 'Date Researched',
    '6sense MID', '6sense Account Name', '6sense Account Country', '6sense Account Domain'
]
